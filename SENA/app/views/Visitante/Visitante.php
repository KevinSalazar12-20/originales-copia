...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div class="row">
            <div class="col-md-11">
                <div class="card" id="TablitaVisitante">
                    <div class="card-header">
                        <b>Visitante</b> <button type="button" id="RegistrarVisitante" class="btn btn-success" data-toggle='tooltip'
                            title=' Agregar un visitante'> <i class="icon-plus"></i> </button>
                    </div>
                    <div class="card-body">
                        ...
                        <form id="formRegistrar" method="POST">
                            <div class="row ">
                                <div class="col-md-5">
                                    ...
                                    <input id="idvisitante" class="form-control" type="number" name="idvisitante" require>
...
<!--main java script-->
<script src="<?php echo RUTA_URL; ?>/js/modulos/Visitante.js"></script>
